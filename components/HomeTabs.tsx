...
const HomeTabs = (props: any) => {
  ...
  return (
    <View
      ...
      className="w-full flex-row justify-center  border-b border-gray-200 bg-light-primary dark:border-dark-secondary dark:bg-dark-primary">
      <TabItem
        href="/"
        active={currentPath === '/'}
        label="Home"
...
const TabItem = (props: any) => {
  ...
  return (
    <TouchableOpacity
      ...
      activeOpacity={0.5}
      className={`mx-8 items-center border-b-2 pb-2 ${props.active ? 'border-black dark:border-white' : 'border-transparent'}`}>
      <Animated.View
        style={{
          width: animatedSize,
          height: animatedSize,
